...
function show_pricing_page() { ?>
		...
		<tr style="vertical-align:top;">
				...
				<h4 class="mo_ldap_local_pricing_sub_header">(You are automatically on this plan)</h4>
				<p></p>
				<hr>
				...
				<hr>
				<br><br><br>
				<p class="mo_ldap_local_pricing_text" style="padding-bottom:10px;">Unlimited LDAP Authentications<br>
				...
				<hr>
				<p class="mo_ldap_local_pricing_text" style="padding:10px;">$149 - One Time Payment</p>
				<p></p><p></p>
				<hr><br>
				<p class="mo_ldap_local_pricing_text" style="padding-bottom:16px !important;">
					...
					Integrated Windows Authentication<br><br>
				</p>
				<hr>
				...
				<hr>
				<p class="mo_ldap_local_pricing_text">$149 + One Time Setup Fees <br>
				( $45 per hour )</p>
				<hr>
